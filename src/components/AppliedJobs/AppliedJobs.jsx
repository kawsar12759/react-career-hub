...
const AppliedJobs = () => {
    ...
    return (
        <div>
            ...
            <div className={appliedJobs.length === 0 ? "max-w-7xl mx-auto flex justify-center items-center h-52 flex items-center" : "hidden"}>
                <h2 className="text-3xl font-bold text-black">You haven't applied to any jobs yet!</h2>
            </div>
            <div className={appliedJobs.length === 0 ? "hidden" : "max-w-7xl mx-auto flex justify-end mb-10"}>
